...
const Contact = () => {
  ...
  return (
    <section id="contact" className="bg-theme-bg px-6 py-32 md:px-20 lg:px-32">
      <div className="max-w-8xl mx-auto grid grid-cols-1 items-center gap-20 lg:grid-cols-2">
        {/* Left: Heading */}
